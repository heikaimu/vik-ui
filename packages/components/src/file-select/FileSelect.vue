...
export default defineComponent({
  ...
  setup(props, ctx) {
    const isMobile = ref(/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(
      navigator.userAgent,
    ))

    // 选择文件
    async function handleSelectFile(e: { target: any }) {
      ...
      const options = {
        ...
        onOpen() {
          setTimeout(() => {
            ...
            const btn = menu[0] as HTMLElement
            btn.click()
          }, 300)
        },
        onUploadDone(res: { filesUploaded: { url: any }[] }) {
          const url = res.filesUploaded[0].url
          fetch(url)
            .then(response => response.blob())
            .then(async (blob) => {
              ctx.emit('select', blob)
            })
        },
      }
          ...
          <div class="third-card-wrapper">
            <div class="svg">
              ...
              <svg viewBox="0 0 20 20">
                <defs>
                  <linearGradient
                    id="linearGradient" x1="6.71416922%" y1="93.4850191%" x2="93.6081727%"
                    y2="6.61873642%"
                  >
                ...
                <g transform="translate(-157.000000, -13.000000)" fill="url(#linearGradient)">
                  ...
                  <g transform="translate(127.500000, 13.000000)">
                    <g transform="translate(60.000000, 0.000000)">
                      <g transform="translate(0.000000, 1.049479)">
                        <g transform="translate(0.000000, 0.117187)" fill="#59C36A">
                          <path
